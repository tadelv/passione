...
<template>
  <div class="recipe-editor">
    ...
    <Transition name="confirm-fade">
      <div v-if="confirmLeave" class="recipe-editor__confirm" @click.self="cancelLeave">
        <div class="recipe-editor__confirm-card">
          <span class="recipe-editor__confirm-text">You have unsaved changes.</span>
          <div class="recipe-editor__confirm-actions">
            <button class="recipe-editor__confirm-btn recipe-editor__confirm-btn--discard" @click="discardAndLeave">Discard</button>
            <button class="recipe-editor__confirm-btn recipe-editor__confirm-btn--cancel" @click="cancelLeave">Stay</button>
            <button class="recipe-editor__confirm-btn recipe-editor__confirm-btn--save" @click="saveAndLeave" :disabled="saving">Save & Leave</button>
          </div>
        </div>
      </div>
    </Transition>
...
.recipe-editor__confirm-text {
  font-size: var(--font-body);
  color: var(--color-text);
  text-align: center;
}

.recipe-editor__confirm-actions {
  display: flex;
  gap: 8px;
  width: 100%;
}

.recipe-editor__confirm-btn {
  flex: 1;
  height: 40px;
  border-radius: 10px;
  border: none;
...
.recipe-editor__confirm-btn--discard { background: var(--color-error); color: var(--color-text); }
.recipe-editor__confirm-btn--cancel { background: transparent; color: var(--color-text-secondary); border: 1px solid var(--color-border); }
.recipe-editor__confirm-btn--save { background: var(--color-primary); color: var(--color-text); }
